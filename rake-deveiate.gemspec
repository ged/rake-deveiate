# -*- encoding: utf-8 -*-
# stub: rake-deveiate 0.5.0.pre.20191030082305 ruby lib

Gem::Specification.new do |s|
  s.name = "rake-deveiate".freeze
  s.version = "0.5.0.pre.20191030082305"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<hglib>.freeze, ["~> 0.5"])
      ...
      s.add_dependency(%q<hglib>.freeze, ["~> 0.5"])
