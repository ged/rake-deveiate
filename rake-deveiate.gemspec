# -*- encoding: utf-8 -*-
# stub: rake-deveiate 0.28.0.pre.20260415103925 ruby lib

Gem::Specification.new do |s|
  s.name = "rake-deveiate".freeze
  s.version = "0.28.0.pre.20260415103925".freeze
  ...
  s.add_runtime_dependency(%q<rake>.freeze, ["~> 13.4".freeze])
  s.add_runtime_dependency(%q<rdoc>.freeze, ["~> 7.0".freeze])
  ...
  s.add_runtime_dependency(%q<rubygems-datadir>.freeze, ["~> 0.0".freeze])
